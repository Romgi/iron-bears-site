    ...
    <main>
      <section className="relative overflow-hidden">
        <div className="pointer-events-none absolute inset-0">
          <div className="absolute -top-24 left-1/2 h-80 w-[44rem] -translate-x-1/2 rounded-full bg-primary/20 blur-3xl" />
          ...
          <div className="grid gap-8 py-12 sm:py-16 lg:grid-cols-2 lg:items-center">
            <div>
              ...
              <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                ...
                <Link
                  href="/sponsors"
                  className="inline-flex items-center justify-center rounded-xl border border-primary/40 bg-black px-5 py-3 text-sm font-semibold text-primary transition hover:bg-primary/10"
                >
                  Sponsor us
                </Link>
              </div>
